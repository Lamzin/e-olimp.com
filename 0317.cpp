...
void product_vect()
{
	for (int i = 0; i < 1000000; i++) c_vect.push_back(0);
...
int main()
{
	...
	while (a_input.length() % 8 != 0) a_input += "0";

	for (int i = 0; i < a_input.length() / 8; i++)
	{
		long long tmp = 0;
		tmp = (a_input[i * 8] - 48)
			+
			(a_input[i * 8 + 1] - 48) * 10
			+
			(a_input[i * 8 + 2] - 48) * 100
			+
			(a_input[i * 8 + 3] - 48) * 1000
			+
			(a_input[i * 8 + 4] - 48) * 10000
			+
			(a_input[i * 8 + 5] - 48) * 100000
			+
			(a_input[i * 8 + 6] - 48) * 1000000
			+
			(a_input[i * 8 + 7] - 48) * 10000000;
	...
	for (int i = c_vect.size() - 1; i >= 0; i--)
	{
		...
		{
			first_zero = false;
			if (c_vect[i] < 10) cout << "0000000";
			else if (c_vect[i] < 100) cout << "000000";
			else if (c_vect[i] < 1000) cout << "00000";
			else if (c_vect[i] < 10000) cout << "0000";
			else if (c_vect[i] < 100000) cout << "000";
			else if (c_vect[i] < 1000000) cout << "00";
			else if (c_vect[i] < 10000000) cout << "0";
